...
import highnes.top.template.security.component.*;
import highnes.top.template.security.util.JwtTokenUtil;
import highnes.top.template.security.util.RestAuthenticationEntryPoint;
import highnes.top.template.security.util.RestfulAccessDeniedHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    //如果有dynamicSecurityService的bean就注入这个bean进入容器内
